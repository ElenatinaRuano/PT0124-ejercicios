...
function App() {
  ...
  const NASA_API_KEY = "RPHtxcIYfoc3cqhgLLAGajYFKioW2nKckwgYf5s7";
  ...
  return (
    <>
      <div className="App">
        <h2 className="title">
          NASA API <img src='https://upload.wikimedia.org/wikipedia/commons/e/e5/NASA_logo.svg' className="logo" alt="NASA LOGO" />
        </h2>
